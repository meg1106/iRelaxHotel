...
public class TDXapi {
	...
	public String getBus() throws Exception{
		String tokenUrl = "https://tdx.transportdata.tw/auth/realms/TDXConnect/protocol/openid-connect/token";
		String tdxUrl = "https://tdx.transportdata.tw/api/basic/v2/Bus/EstimatedTimeOfArrival/City/Taichung?%24select=StopSequence%2CPlateNumb&%24filter=StopName%2FZh_tw%20eq%20%27%E5%85%AC%E7%9B%8A%E5%A4%A7%E5%A2%A9%E8%B7%AF%E5%8F%A3%27&%24top=30&%24format=JSON";
		
        List<NameValuePair> params = new ArrayList<>();
        Map<String,String> headers = new HashMap<>();
        params.add(new BasicNameValuePair("grant_type", "client_credentials"));
        params.add(new BasicNameValuePair("client_id", "s1042180-7261d862-223d-4e9f")); //your clientId
        params.add(new BasicNameValuePair("client_secret", "da220e20-4494-4afd-850e-f056f838a3be")); //your clientSecret
